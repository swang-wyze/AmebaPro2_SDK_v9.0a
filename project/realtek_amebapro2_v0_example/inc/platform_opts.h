...
#define FAST_RECONNECT_DATA		(0x800000 - 0x1000)
...
/*Disable wifi fast connect when CONFIG_GAGENT is enabled,because
...
/* for Azure iot hub example*/
#define CONFIG_EXAMPLE_AZURE_IOT_HUB     0
...
/* pleas also disable wifi fast connect*/
#endif
#endif
...
#undef CONFIG_INCLUDE_SIMPLE_CONFIG
#define CONFIG_INCLUDE_SIMPLE_CONFIG		0
/* please also disable wifi fast connect*/
#endif
