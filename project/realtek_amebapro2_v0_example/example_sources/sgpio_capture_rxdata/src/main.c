...
int main(void)
{
	...
	// Init SGPIO RX
	sgpio_capture_compare_rxdata(&sgpio_obj, ENABLE, RXTC_FALL_EDGE, CAP_RISE_EDGE, 100, UNIT_US, 35, GET_BIT0, RX_CAPTURING_BIT_CNT, FIRST_LSB,
								 sgpio_rxdata_end_handler, &sgpio_obj);
