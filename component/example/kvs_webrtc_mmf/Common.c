...
#if (CONFIG_EXAMPLE_KVS_WEBRTC || CONFIG_EXAMPLE_KVS_WEBRTC_MMF || CONFIG_EXAMPLE_KVS_WEBRTC_PRODUCER_MMF)
									...
									PSampleStreamingSession *ppSampleStreamingSession)
{
	...
	CHK_STATUS(addTransceiver(pSampleStreamingSession->pPeerConnection, pVideoTrack, &videoRtcRtpTransceiverInit,
...
#endif
	CHK_STATUS(addTransceiver(pSampleStreamingSession->pPeerConnection, pAudioTrack, &audioRtcRtpTransceiverInit,
