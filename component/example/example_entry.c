...
#if defined(CONFIG_EXAMPLE_WIFI_SCAN_MCC) && CONFIG_EXAMPLE_WIFI_SCAN_MCC
#include <wifi_scan_mcc/example_wifi_scan_mcc.h>
#endif
...
#if defined(CONFIG_USB_DEVICE_NEW_EN) && CONFIG_USB_DEVICE_NEW_EN
#include <usbd_cdc_acm_new/example_usbd_cdc_acm_new.h>
#else
...
#if defined(CONFIG_USB_HOST_NEW_EN) && CONFIG_USB_HOST_NEW_EN
#include <usbh_cdc_acm_new/example_usbh_cdc_acm_new.h>
#else
...
#if defined(CONFIG_EXAMPLE_MEDIA_MP4_DEMUXER) && CONFIG_EXAMPLE_MEDIA_MP4_DEMUXER
...
#if (defined(CONFIG_PLATFORM_8710C) || defined(CONFIG_PLATFORM_8735B)) && defined(CONFIG_FTL_ENABLED)
	app_ftl_init();
#endif
