...
#if defined(CONFIG_RTL8711B) || defined(CONFIG_RTL8721D) || defined(CONFIG_RTL8195B) || defined(CONFIG_RTL8710C) || defined(CONFIG_RTL8730A) || defined(CONFIG_RTL8735B) // buffer descriptor architecture
#define TXDESC_OFFSET TXDESC_SIZE
#else
...
struct tx_desc {
	...
	unsigned int txdw7;
#if defined(CONFIG_LX_HCI)||defined(CONFIG_RTL8188F) ||defined(CONFIG_RTL8192E) ||defined(CONFIG_RTL8723D) ||defined(CONFIG_RTL8195B) || defined(CONFIG_RTL8710C) || defined(CONFIG_RTL8735B) || defined(CONFIG_RTL8730A)
	unsigned int txdw8;
...
struct rtw_tx_ring {
#if ((RTL8711B_SUPPORT == 1) || (RTL8721D_SUPPORT == 1) || (RTL8195B_SUPPORT == 1) || (RTL8710C_SUPPORT == 1) || (RTL8730A_SUPPORT == 1) || (RTL8735B_SUPPORT == 1))
...
struct xmit_frame {
	...
	int tx_shortcut_idx;
#endif
#ifdef RTL8730A_WIFI_TEST//UL MU
	u8 trigger_type;
#endif
};
