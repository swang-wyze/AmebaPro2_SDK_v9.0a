 ...
 * \param[in]  method             APP launch method \ref BT_IAP_APP_LAUNCH_METHOD.
 *
...
bool bt_iap_app_launch(uint8_t *bd_addr, char *boundle_id, uint8_t len_boundle_id,
					   BT_IAP_APP_LAUNCH_METHOD method);
 ...
 * \param[in]  param_id       The parameter id \ref BT_IAP_EXTERNAL_PROTOCOL, \ref BT_IAP_IDENTIFICATION_INFO_ID, \ref BT_IAP_TRANSPORT.
 ...
 * \ingroup BT_IAP
 */
bool bt_iap_param_set(BT_IAP_PARAM_TYPE type, uint8_t len, void *p_value);
