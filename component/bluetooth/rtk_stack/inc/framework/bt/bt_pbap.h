 ...
 *
 * \param[in]  bd_addr         Remote BT address.
 * \param[in]  repos           Repository containing the phone book \ref BT_PBAP_REPOSITORY.
 * \param[in]  phone_book      The phone book object to be retrieved \ref BT_PBAP_PHONE_BOOK.
 ...
 * \param[in]  bd_addr    Remote BT address.
 * \param[in]  repos      Repository containing the phone book \ref BT_PBAP_REPOSITORY.
 * \param[in]  path       The phone book to be set \ref BT_PBAP_PATH.
 *
 ...
 * \ingroup BT_PBAP
 */
bool bt_pbap_phone_book_set(uint8_t *bd_addr, BT_PBAP_REPOSITORY repos, BT_PBAP_PATH path);
