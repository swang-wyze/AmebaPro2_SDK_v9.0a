...
{
	os_task_create(&bt_mesh_provisioner_multiple_profile_app_task_handle, "bt_mesh_provisioner_multiple_profile_app",
				   bt_mesh_provisioner_multiple_profile_app_main_task, 0, APP_TASK_STACK_SIZE,
				   APP_TASK_PRIORITY);
}
