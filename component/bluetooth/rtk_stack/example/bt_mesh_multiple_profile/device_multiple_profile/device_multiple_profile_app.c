...
void bt_mesh_device_multiple_profile_app_handle_conn_param_update_evt(uint8_t conn_id, uint8_t status, uint16_t cause)
{
	...
	case GAP_CONN_PARAM_UPDATE_STATUS_SUCCESS: {
		...
		printf("bt_mesh_device_multiple_profile_app_handle_conn_param_update_evt update success:conn_id %d, conn_interval 0x%x, conn_slave_latency 0x%x, conn_supervision_timeout 0x%x \r\n",
			   conn_id, conn_interval, conn_slave_latency, conn_supervision_timeout);
	}
	break;
	...
	case GAP_CONN_PARAM_UPDATE_STATUS_FAIL: {
		APP_PRINT_ERROR2("bt_mesh_device_multiple_profile_app_handle_conn_param_update_evt update failed: conn_id %d, cause 0x%x",
						 conn_id, cause);
		printf("bt_mesh_device_multiple_profile_app_handle_conn_param_update_evt update failed: conn_id %d, cause 0x%x\r\n",
			   conn_id, cause);
	}
	break;
	...
	case GAP_CONN_PARAM_UPDATE_STATUS_PENDING: {
		...
		printf("bt_mesh_device_multiple_profile_app_handle_conn_param_update_evt update pending: conn_id %d\r\n", conn_id);
	}
	break;
