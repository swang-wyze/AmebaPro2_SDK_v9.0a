...
{
	client_init(1);
	ble_tizenrt_central_gcs_client_id = gcs_add_client(ble_tizenrt_central_gcs_client_callback, BLE_TIZENRT_CENTRAL_APP_MAX_LINKS,
										BLE_TIZENRT_CENTRAL_APP_MAX_DISCOV_TABLE_NUM);
