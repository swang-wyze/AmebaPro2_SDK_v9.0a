...
void ble_tizenrt_central_app_task_init()
{
	...
	os_task_create(&ble_tizenrt_central_callback_task_handle, "tizenrt_central_callback", ble_tizenrt_central_callback_task, 0,
				   BLE_TIZENRT_CENTRAL_CALLBACK_TASK_STACK_SIZE,
