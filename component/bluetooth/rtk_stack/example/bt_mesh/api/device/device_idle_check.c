...
uint8_t bt_mesh_idle_check_init(void)
{
	...
	bt_mesh_access_data_flow_monitor_timer = plt_timer_create("bt_mesh_access_data_flow_monitor_timer", 0xFFFFFFFF, FALSE, NULL,
			bt_mesh_access_data_flow_monitor_timer_handler);
