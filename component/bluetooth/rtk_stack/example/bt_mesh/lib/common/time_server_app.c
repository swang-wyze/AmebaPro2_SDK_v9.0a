...
static int32_t time_server_data(const mesh_model_info_p pmodel_info, uint32_t type, void *pargs)
{
	...
	case TIME_SERVER_GET: {
		...
		printf("time server receive: tai seconds %d, subsecond %d, uncertainty %d, time authority %d, tai utc delta %d, time zone offset %d \r\n",
	...
	case TIME_SERVER_GET_ZONE: {
		...
		printf("time server receive: current time zone offset %d, new time zone offset %d, tai of zone change %d \r\n",
	...
	case TIME_SERVER_GET_TAI_UTC_DELTA: {
		...
		printf("time server receive: current tai utc delta %d, padding1 %d, new tai utc delta %d, padding2 %d, tai of delta change %d \r\n",
	...
	case TIME_SERVER_STATUS_SET: {
		...
		printf("time server receive: tai seconds %d, subsecond %d, uncertainty %d, tai utc delta %d, time zone offset %d \r\n",
...
static int32_t time_setup_server_data(const mesh_model_info_p pmodel_info, uint32_t type, void *pargs)
{
	...
	case TIME_SERVER_SET: {
		...
		printf("time server receive: set tai seconds %d, subsecond %d, uncertainty %d, time authority %d, tai utc delta %d, time zone offset %d \r\n",
	...
	case TIME_SERVER_SET_ZONE: {
		...
		printf("time setup server receive: set tai of zone change %d, new time zone offset new %d \r\n",
	...
	case TIME_SERVER_GET_ROLE: {
		...
		printf("time setup server receive: role %d \r\n",
			   time_role.role);
	}
	break;
	case TIME_SERVER_SET_ROLE: {
		...
		printf("time setup server receive: set role %d \r\n",
	...
	case TIME_SERVER_SET_TAI_UTC_DELTA: {
		...
		printf("time setup server receive: set tai of delta change %d, new time utc delta %d, padding %d \r\n",
