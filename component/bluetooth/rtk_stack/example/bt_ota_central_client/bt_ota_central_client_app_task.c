...
{
	os_task_create(&bt_ota_central_client_app_task_handle, "bt_ota_central_client_app", bt_ota_central_client_app_main_task, 0,
				   BT_OTA_CENTRAL_CLIENT_APP_TASK_STACK_SIZE,
