...
#define mbedtls_printf     dbg_printf
...
#if 0
///Get these three addresses from target_ns.map
#define ADDR_ADD_COUNT 0x1003fa64
#define ADDR_DBL_COUNT 0x1003fa68
#define ADDR_MUL_COUNT 0x1003fa6c
#define add_count (*(unsigned long *)ADDR_ADD_COUNT)
#define dbl_count (*(unsigned long *)ADDR_DBL_COUNT)
#define mul_count (*(unsigned long *)ADDR_MUL_COUNT)
#else
...
static const unsigned char ctr_entropy_source_pr[96] = {
...
static const unsigned char ctr_entropy_source_nopr[64] = {
...
static const unsigned char ctr_nonce_pers_pr[16] = {
	0xd2, 0x54, 0xfc, 0xff, 0x02, 0x1e, 0x69, 0xd2,
	0x29, 0xc9, 0xcf, 0xad, 0x85, 0xfa, 0x48, 0x6c
};

static const unsigned char ctr_nonce_pers_nopr[16] = {
...
static size_t ctr_test_offset;
static int ctr_drbg_self_test_entropy(void *data, unsigned char *buf,
									  size_t len)
{
	const unsigned char *p = data;
	memcpy(buf, p + ctr_test_offset, len);
	ctr_test_offset += len;
	return (0);
}
...
int mbedtls_ctr_drbg_self_test(int verbose)
{
	...
	CHK(mbedtls_ctr_drbg_seed_entropy_len(&ctx, ctr_drbg_self_test_entropy,
										  (void *) ctr_entropy_source_pr, ctr_nonce_pers_pr, 16, 32));
	...
	ctr_test_offset = 0;
	CHK(mbedtls_ctr_drbg_seed_entropy_len(&ctx, ctr_drbg_self_test_entropy,
										  (void *) ctr_entropy_source_nopr, ctr_nonce_pers_nopr, 16, 32));
...
static const unsigned char hmac_entropy_pr[] = {
...
static const unsigned char hmac_entropy_nopr[] = {
...
/* "Entropy" from buffer */
static size_t hmac_test_offset;
static int hmac_drbg_self_test_entropy(void *data,
									   unsigned char *buf, size_t len)
{
	const unsigned char *p = data;
	memcpy(buf, p + hmac_test_offset, len);
	hmac_test_offset += len;
	return (0);
}
...
int mbedtls_hmac_drbg_self_test(int verbose)
{
	...
	CHK(mbedtls_hmac_drbg_seed(&ctx, md_info,
							   hmac_drbg_self_test_entropy, (void *) hmac_entropy_pr,
							   NULL, 0));
	...
	hmac_test_offset = 0;
	CHK(mbedtls_hmac_drbg_seed(&ctx, md_info,
							   hmac_drbg_self_test_entropy, (void *) hmac_entropy_nopr,
							   NULL, 0));
