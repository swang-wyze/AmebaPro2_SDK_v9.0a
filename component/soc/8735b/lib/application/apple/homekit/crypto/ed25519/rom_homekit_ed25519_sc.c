...
*/
APPLE_ROM_TEXT_SECTION
void rom_ed25519_sc_muladd(unsigned char *s, const unsigned char *a, const unsigned char *b, const unsigned char *c)
{
...
*/
APPLE_ROM_TEXT_SECTION
void rom_ed25519_sc_reduce(unsigned char *s)
{
