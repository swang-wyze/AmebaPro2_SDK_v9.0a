...
void spic_wait_ready_nsc(SPIC_TypeDef *spic_dev);
void spic_flush_fifo_nsc(SPIC_TypeDef *spic_dev);
hal_status_t spic_pinmux_ctl_nsc(phal_spic_adaptor_t phal_spic_adaptor, u8 ctl);
...
#define spic_pinmux_ctl                 spic_pinmux_ctl_nsc
