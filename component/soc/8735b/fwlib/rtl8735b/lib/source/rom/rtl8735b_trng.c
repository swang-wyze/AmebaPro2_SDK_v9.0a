...
/**
  \brief  The stubs functions table of the trng HAL functions in ROM.
*/
SECTION_TRNG_STUBS
const hal_trng_func_stubs_t hal_trng_stubs = {
	.ptrng_adp = &ptrng_adapter,
	.hal_trng_enable_128K = hal_rtl_trng_enable_128K,
	.hal_trng_enable_32K = hal_rtl_trng_enable_32K,
	.hal_trng_disable = hal_rtl_trng_disable,
	.hal_trng_reg_irq = hal_rtl_trng_reg_irq,
	.hal_trng_control_setting = hal_rtl_trng_control_setting,
	.hal_trng_init = hal_rtl_trng_init,
	.hal_trng_deinit = hal_rtl_trng_deinit,
	.hal_trng_load_default = hal_rtl_trng_load_default,
	.hal_trng_reset = hal_rtl_trng_reset,
	.hal_trng_self_test_setting = hal_rtl_trng_self_test_setting,
	.hal_trng_interrupt_reg = hal_rtl_trng_interrupt_reg,
	.hal_trng_read_readybit = hal_rtl_trng_read_readybit,
	.hal_trng_read_parity_error_interrupt = hal_rtl_trng_read_parity_error_interrupt,
	.hal_trng_clear_interrupt = hal_rtl_trng_clear_interrupt,
	.hal_trng_read_data = hal_rtl_trng_read_data,
};
...
{
	////dbg_printf("hal_rtl_trng_enable_128K \n\r ");
#if !defined(CONFIG_BUILD_NONSECURE)
	hal_rtl_sys_peripheral_en(TRNG_128K, ENABLE);
#endif
	hal_delay_ms(100);
	////dbg_printf("hal_rtl_trng_enable_128K 133 \n\r ");
...
{
////dbg_printf("hal_rtl_trng_enable_32K \n\r ");
#if !defined(CONFIG_BUILD_NONSECURE)
	hal_rtl_sys_peripheral_en(TRNG_128K, ENABLE);
#endif
...
SECTION_TRNG_TEXT
void hal_rtl_trng_disable(hal_trng_adapter_t *ptrng_adp)
{
	////dbg_printf("hal_rtl_trng_disable \n\r ");
#if !defined(CONFIG_BUILD_NONSECURE)
	hal_rtl_sys_peripheral_en(TRNG_128K, DISABLE);
#endif
}
/**
 ...
 */
SECTION_TRNG_TEXT
void hal_rtl_trng_comm_irq_reg(irq_handler_t irq_handler)
{
 ...
 */
SECTION_TRNG_TEXT
void hal_rtl_trng_comm_irq_unreg(void)
{
...
hal_status_t hal_rtl_trng_init(hal_trng_adapter_t *ptrng_adp)
{
	...
	_memset((void *)ptrng_adp, 0, sizeof(hal_trng_adapter_t));
	ptrng_adapter = ptrng_adp; // Initialize ptrng_adpter
	hal_rtl_trng_comm_irq_reg((irq_handler_t)trng_IRQHandler);
	return HAL_OK;
}
 ...
 */
SECTION_TRNG_TEXT
hal_status_t hal_rtl_trng_deinit(hal_trng_adapter_t *ptrng_adp)
{
////dbg_printf("hal_rtl_trng_deinit \n\r ");
	hal_rtl_trng_comm_irq_unreg();
	hal_rtl_trng_disable(ptrng_adp);
	ptrng_adapter = NULL;
	return HAL_OK;
...
void  hal_rtl_trng_reset(hal_trng_adapter_t *ptrng_adp)
{
	...
	// //dbg_printf("ptrng_adp->trng_reg.hal_rtl_trng_reset = %x \n\r", TRNG->TRNG_RNG_CTRL);
...
void  hal_rtl_trng_self_test_setting(hal_trng_adapter_t *ptrng_adp, hal_rng_st_reg_t *ptrng_st_reg)
{
	...
	////dbg_printf("((ptrng_st_reg->thr_done_adap1) << TRNG_SHIFT_THR_DONE_ADAP1) = %x \n\r",((ptrng_st_reg->thr_done_adap1) << TRNG_SHIFT_THR_DONE_ADAP1));
	ptrng_adp->trng_reg.TRNG_RNG_ST_SETTING |= ((ptrng_st_reg->thr_done_adap2) << TRNG_SHIFT_THR_DONE_ADAP2); // TRNG_mode
	////dbg_printf("((ptrng_st_reg->thr_done_adap2) << TRNG_SHIFT_THR_DONE_ADAP2 = %x \n\r",((ptrng_st_reg->thr_done_adap2) << TRNG_SHIFT_THR_DONE_ADAP2));
	ptrng_adp->trng_reg.TRNG_RNG_ST_SETTING |= ((ptrng_st_reg->compare_rep) << TRNG_SHIFT_COMPARE_REP); // selftest
	////dbg_printf("((ptrng_st_reg->compare_rep) << TRNG_SHIFT_COMPARE_REP) = %x \n\r",((ptrng_st_reg->compare_rep) << TRNG_SHIFT_COMPARE_REP));
	...
	////dbg_printf("ptrng_adp->trng_reg.TRNG_RNG_ST_SETTING = %x \n\r",ptrng_adp->trng_reg.TRNG_RNG_ST_SETTING);
