...
void hal_gpio_comm_init_nsc(phal_gpio_comm_adapter_t pgpio_comm_adp);
void hal_aon_gpio_comm_init_nsc(phal_aon_gpio_comm_adapter_t paon_gpio_comm_adp);
void hal_pon_gpio_comm_init_nsc(phal_pon_gpio_comm_adapter_t ppon_gpio_comm_adp);
void hal_gpio_comm_deinit_nsc(void);
void hal_aon_gpio_comm_deinit_nsc(void);
void hal_pon_gpio_comm_deinit_nsc(void);
...
void hal_gpio_enter_critical_nsc(void);
void hal_aon_gpio_enter_critical_nsc(void);
void hal_pon_gpio_enter_critical_nsc(void);
void hal_gpio_exit_critical_nsc(void);
void hal_aon_gpio_exit_critical_nsc(void);
void hal_pon_gpio_exit_critical_nsc(void);
...
#define hal_gpio_comm_init              hal_gpio_comm_init_nsc
#define hal_aon_gpio_comm_init          hal_aon_gpio_comm_init_nsc
#define hal_pon_gpio_comm_init          hal_pon_gpio_comm_init_nsc
#define hal_gpio_comm_deinit            hal_gpio_comm_deinit_nsc
#define hal_aon_gpio_comm_deinit        hal_aon_gpio_comm_deinit_nsc
#define hal_pon_gpio_comm_deinit        hal_pon_gpio_comm_deinit_nsc
#define hal_gpio_init                   hal_gpio_init_nsc
#define hal_gpio_deinit                 hal_gpio_deinit_nsc
#define hal_gpio_irq_init               hal_gpio_irq_init_nsc
#define hal_gpio_irq_deinit             hal_gpio_irq_deinit_nsc
#define hal_gpio_port_init              hal_gpio_port_init_nsc
#define hal_gpio_port_deinit            hal_gpio_port_deinit_nsc
#define hal_gpio_port_dir               hal_gpio_port_dir_nsc

#define hal_gpio_reg_irq                hal_gpio_reg_irq_nsc
#define hal_gpio_interrupt_clk_sel      hal_gpio_interrupt_clk_sel_nsc
#define hal_gpio_enter_critical         hal_gpio_enter_critical_nsc
#define hal_aon_gpio_enter_critical     hal_aon_gpio_enter_critical_nsc
#define hal_pon_gpio_enter_critical     hal_pon_gpio_enter_critical_nsc
#define hal_gpio_exit_critical          hal_gpio_exit_critical_nsc
#define hal_aon_gpio_exit_critical      hal_aon_gpio_exit_critical_nsc
#define hal_pon_gpio_exit_critical      hal_pon_gpio_exit_critical_nsc
#define hal_gpio_set_dir                hal_gpio_set_dir_nsc
#define hal_gpio_get_dir                hal_gpio_get_dir_nsc
#define hal_gpio_write                  hal_gpio_write_nsc
#define hal_gpio_toggle                 hal_gpio_toggle_nsc
#define hal_gpio_read                   hal_gpio_read_nsc
#define hal_gpio_debounce_enable        hal_gpio_debounce_enable_nsc
#define hal_gpio_read_debounce          hal_gpio_read_debounce_nsc
#define hal_gpio_debounce_disable       hal_gpio_debounce_disable_nsc
#define hal_gpio_irq_set_trig_type      hal_gpio_irq_set_trig_type_nsc
#define hal_gpio_irq_get_trig_type      hal_gpio_irq_get_trig_type_nsc
#define hal_gpio_irq_enable             hal_gpio_irq_enable_nsc
#define hal_gpio_irq_disable            hal_gpio_irq_disable_nsc
#define hal_gpio_irq_debounce_enable    hal_gpio_irq_debounce_enable_nsc
#define hal_gpio_irq_debounce_disable   hal_gpio_irq_debounce_disable_nsc
#define hal_gpio_irq_read               hal_gpio_irq_read_nsc
#define hal_gpio_port_write             hal_gpio_port_write_nsc
#define hal_gpio_port_read              hal_gpio_port_read_nsc

#define hal_gpio_pull_ctrl              hal_gpio_pull_ctrl_nsc
#define hal_gpio_schmitt_ctrl           hal_gpio_schmitt_ctrl_nsc
#define hal_gpio_drive_ctrl             hal_gpio_drive_ctrl_nsc
#define hal_gpio_slew_rate_ctrl         hal_gpio_slew_rate_ctrl_nsc

// Newly added define will come here for greater clarity when debugging - added from 30JUL2021 onwards， only for MP A-cut chip and beyond
#define aon_gpio_sclk_source_select		aon_gpio_sclk_source_select_nsc
