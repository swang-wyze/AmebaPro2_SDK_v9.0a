/**************************************************************************//**
 * @file     rtl8735b_handler_ns.c
 * @brief    Startup for Non-Secure region.
 * @version  V1.00
 * @date     2020-11-25
 *
 * @note
...
/*----------------------------------------------------------------------------
  External References
 *----------------------------------------------------------------------------*/
extern void start_ns_rtl8710c(void) __attribute__((noreturn));    /* main entry point */
#define __START    start_ns_rtl8710c
...
#if 0
// not allocate heap size in rom stage
#ifndef __HEAP_SIZE
 ...
 *----------------------------------------------------------------------------*/
const pFunc __Vectors_NS[] __attribute__((section(".rom_ns.vectors"))) = {
